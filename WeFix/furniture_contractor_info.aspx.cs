...
namespace WeFix
{
    public partial class furniture_contractor_info : System.Web.UI.Page
    {
        Second ob = new Second();
        protected void Page_Load(object sender, EventArgs e)
        {
            string sQuery = "SELECT name,work_type,skills,phoneno,email,location,price from contractor where work_type='furniture'";

...
namespace WeFix
{
    public partial class painter_contractor : System.Web.UI.Page
    {
        Second ob = new Second();
        protected void Page_Load(object sender, EventArgs e)
        {
            string sQuery = "SELECT name,work_type,skills,phoneno,email,location,price from contractor where work_type='painting'";
